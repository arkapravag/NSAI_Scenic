...
scenic special_scenarios/5.scenic --2d --model scenic.simulators.carla.model --simulate

"""

param map = localPath('../assets/maps/CARLA/Town10HD.xodr')  # or other CARLA map that definitely works
param carla_map = 'Town10HD'
model scenic.domains.carla.model
...
# PLACEMENT
ego = new Car with blueprint "vehicle.audi.tt", following roadDirection from egoStart for EGO_OFFSET,
