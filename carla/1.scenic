...
A parked car abruptly pulls up into the road and brakes for a moment

scenic special_scenarios/1.scenic --2d --model scenic.simulators.carla.model --simulate
...
behavior PullIntoRoad():
    ...
    interrupt when 18 * STEPS_PER_SEC < simulation().currentTime and simulation().currentTime < 21 * STEPS_PER_SEC:
