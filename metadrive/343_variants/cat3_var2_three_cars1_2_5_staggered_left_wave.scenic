...
# Variant: c3_v2_staggered_left_turn_wave
# Modified vehicles: car1->delayedLeftTurnCut(L_centerlines), car2->aggressiveLeftTurn(L_centerlines), car4->rollingRoadblock()
...
car2 = new Car at -128.5 @ 27, with behavior aggressiveLeftTurn(L_centerlines)
car3 = new Car at -132 @ 16, with behavior onComingStraight()
car4 = new Car at -132 @ 26, with behavior rollingRoadblock()
