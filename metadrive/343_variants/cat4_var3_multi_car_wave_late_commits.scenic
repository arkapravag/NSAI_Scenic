...
# Variant: c4_v3_wave_of_late_commits
# Modified vehicles: car2->delayedLeftTurnCut(L_centerlines), car4->steerAcrossLaneLeft(), car5->suddenSprintStraight(), car7->rollingRoadblock(), car8->rollingRoadblock(), car11->steerAcrossLaneRight()
...
car2 = new Car at -128.5 @ 27, with behavior delayedLeftTurnCut(L_centerlines)
car3 = new Car at -132 @ 16, with behavior onComingStraight()
car4 = new Car at -132 @ 26, with behavior steerAcrossLaneLeft()
car5 = new Car at -128 @ 36, with behavior suddenSprintStraight()
car6 = new Car at -121 @ -25, with behavior carBesideEgoBehavior()
car7 = new Car at -128.5 @ 51, with behavior rollingRoadblock()
car8 = new Car at -128.5 @ 71, with behavior rollingRoadblock()
car9 = new Car at -128.5 @ 91, with behavior changeLane()
car10 = new Car at -128.5 @ 111, with behavior onComingStraight()
car11 = new Car at -132 @ 41, with behavior steerAcrossLaneRight()
car12 = new Car at -132 @ 61, with behavior onComingStraight()
