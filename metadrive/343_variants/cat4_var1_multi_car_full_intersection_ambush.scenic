...
# Variant: c4_v1_full_intersection_ambush
# Modified vehicles: car1->aggressiveLeftTurn(L_centerlines), car2->delayedLeftTurnCut(L_centerlines), car3->intersectionBlocker(), car4->rollingRoadblock(), car6->fastApproachFromBehind()
