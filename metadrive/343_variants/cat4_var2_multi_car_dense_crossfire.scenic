...
# Variant: c4_v2_dense_crossfire
# Modified vehicles: car1->aggressiveLeftTurn(L_centerlines), car3->hardBrakeInFront(), car5->suddenSprintStraight(), car6->fastApproachFromBehind(), car9->stagedLaneChangeAttack(), car11->intersectionBlocker()
