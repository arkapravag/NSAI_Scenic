...
# Variant: c3_v1_three_car_intersection_snare
# Modified vehicles: car1->aggressiveLeftTurn(L_centerlines), car3->intersectionBlocker(), car6->fastApproachFromBehind()
