...
car1 = new Car at 287 @ -195, with behavior creepThenExplode(5.0, 1, 16)
car2 = new Car at 318 @ -199.5, with behavior delayedAggressiveRightTurn(3.0, 18, ego_R_centerlines)
car4 = new Car at 338.5 @ -215, with behavior rollingBlockThenDash(2.5, 2, 22)
car3 = new Car at 338.5 @ -225, with behavior hesitantThenTurn(2.0, 1, 22, ego_L_centerlines)
car4b = new Car at 338.5 @ -235, with behavior delayedAggressiveLeftTurn(2.8, 24, ego_L_centerlines)
car5 = new Car at 338.5 @ -245, with behavior delayedAggressiveLeftTurn(3.4, 27, ego_L_centerlines)
