...
car2 = new Car at 318 @ -199.5, with behavior delayedAggressiveRightTurn(2.5, 20, ego_R_centerlines)
car4 = new Car at 338.5 @ -215, with behavior stopThenGoStraight(2.0, 28)
car3 = new Car at 338.5 @ -225, with behavior hesitantThenTurn(1.8, 1, 24, ego_L_centerlines)
