...
car2 = new Car at 318 @ -199.5, with behavior delayedAggressiveRightTurn(1.8, 18, ego_R_centerlines)
car4 = new Car at 338.5 @ -215, with behavior straightPassingCar
car3 = new Car at 338.5 @ -225, with behavior delayedAggressiveLeftTurn(2.2, 22, ego_L_centerlines)
