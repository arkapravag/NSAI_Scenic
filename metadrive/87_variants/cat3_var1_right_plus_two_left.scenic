...
car2 = new Car at 318 @ -199.5, with behavior delayedAggressiveRightTurn(1.7, 18, ego_R_centerlines)
car4 = new Car at 338.5 @ -215, with behavior delayedStraightDash(2.4, 20)
car3 = new Car at 338.5 @ -225, with behavior delayedAggressiveLeftTurn(2.0, 22, ego_L_centerlines)
