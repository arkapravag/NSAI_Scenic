...
car1 = new Car at 287 @ -195, with behavior stopThenGoStraight(3.5, 14)
car2 = new Car at 318 @ -199.5, with behavior delayedAggressiveRightTurn(1.5, 21, ego_R_centerlines)
car4 = new Car at 338.5 @ -215, with behavior delayedStraightDash(1.8, 26)
car3 = new Car at 338.5 @ -225, with behavior delayedAggressiveLeftTurn(1.4, 20, ego_L_centerlines)
car4b = new Car at 338.5 @ -235, with behavior delayedAggressiveLeftTurn(2.2, 23, ego_L_centerlines)
car5 = new Car at 338.5 @ -245, with behavior delayedAggressiveLeftTurn(2.8, 25, ego_L_centerlines)
