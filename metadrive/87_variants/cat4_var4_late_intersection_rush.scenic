...
car1 = new Car at 287 @ -195, with behavior creepThenExplode(6.0, 1, 20)
car2 = new Car at 318 @ -199.5, with behavior delayedAggressiveRightTurn(4.0, 20, ego_R_centerlines)
car4 = new Car at 338.5 @ -215, with behavior delayedStraightDash(3.8, 24)
car3 = new Car at 338.5 @ -225, with behavior delayedAggressiveLeftTurn(3.5, 24, ego_L_centerlines)
car4b = new Car at 338.5 @ -235, with behavior delayedAggressiveLeftTurn(4.2, 26, ego_L_centerlines)
car5 = new Car at 338.5 @ -245, with behavior delayedAggressiveLeftTurn(4.5, 30, ego_L_centerlines)
