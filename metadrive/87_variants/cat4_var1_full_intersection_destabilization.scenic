...
car1 = new Car at 287 @ -195, with behavior stopThenGoStraight(4.0, 18)
car2 = new Car at 318 @ -199.5, with behavior delayedAggressiveRightTurn(2.0, 20, ego_R_centerlines)
car4 = new Car at 338.5 @ -215, with behavior delayedStraightDash(2.2, 24)
car3 = new Car at 338.5 @ -225, with behavior delayedAggressiveLeftTurn(1.8, 22, ego_L_centerlines)
car4b = new Car at 338.5 @ -235, with behavior delayedAggressiveLeftTurn(2.6, 24, ego_L_centerlines)
car5 = new Car at 338.5 @ -245, with behavior delayedAggressiveLeftTurn(3.0, 28, ego_L_centerlines)
