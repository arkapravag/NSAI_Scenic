...
car1 = new Car at 287 @ -195, with behavior stopThenGoStraight(2.5, 12)
car2 = new Car at 318 @ -199.5, with behavior delayedAggressiveRightTurn(2.2, 19, ego_R_centerlines)
car4 = new Car at 338.5 @ -215, with behavior rollingBlockThenDash(1.8, 3, 24)
car3 = new Car at 338.5 @ -225, with behavior hesitantThenTurn(1.6, 1, 20, ego_L_centerlines)
car4b = new Car at 338.5 @ -235, with behavior delayedAggressiveLeftTurn(2.4, 22, ego_L_centerlines)
car5 = new Car at 338.5 @ -245, with behavior delayedAggressiveLeftTurn(2.9, 24, ego_L_centerlines)
