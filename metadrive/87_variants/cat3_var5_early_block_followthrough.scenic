...
car2 = new Car at 318 @ -199.5, with behavior rightTurnBehavior(4, ego_R_centerlines)
car4 = new Car at 338.5 @ -215, with behavior rollingBlockThenDash(2.5, 3, 25)
car3 = new Car at 338.5 @ -225, with behavior delayedAggressiveLeftTurn(1.2, 21, ego_L_centerlines)
car4b = new Car at 338.5 @ -235, with behavior leftTurningBehavior(8, ego_L_centerlines)
car5 = new Car at 338.5 @ -245, with behavior delayedAggressiveLeftTurn(2.8, 23, ego_L_centerlines)
