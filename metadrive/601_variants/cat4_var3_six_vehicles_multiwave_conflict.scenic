...
parkedCar.behavior = DelayedLaunch(1.2, 18)

leadCar = new Car offset along ego.orientation by 0 @ 20,
    with behavior SuddenBrake(1.8, 15)

rearCar = new Car offset along ego.orientation by 0 @ -28,
    with behavior Cruise(30)

leftWingCar = new Car offset along ego.orientation by -3.5 @ -6,
    with behavior Cruise(23)

rightWingCar = new Car offset along ego.orientation by 3.5 @ -9,
    with behavior Cruise(21)

farLeadCar = new Car offset along ego.orientation by 0 @ 34,
    with behavior RollingBlock(4)
