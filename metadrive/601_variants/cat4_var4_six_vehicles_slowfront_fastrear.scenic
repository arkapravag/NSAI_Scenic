...
parkedCar.behavior = RollingBlock(4)

leadCar = new Car offset along ego.orientation by 0 @ 16,
    with behavior RollingBlock(2)

rearCar = new Car offset along ego.orientation by 0 @ -22,
    with behavior Cruise(31)

leftWingCar = new Car offset along ego.orientation by -3.5 @ -8,
    with behavior Cruise(24)

rightWingCar = new Car offset along ego.orientation by 3.5 @ -8,
    with behavior Cruise(24)

farRearCar = new Car offset along ego.orientation by 0 @ -40,
    with behavior Cruise(32)
