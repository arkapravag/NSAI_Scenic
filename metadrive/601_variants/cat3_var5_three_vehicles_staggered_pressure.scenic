...
parkedCar.behavior = DelayedLaunch(1.4, 16)

leadCar = new Car offset along ego.orientation by 0 @ 25,
    with behavior SuddenBrake(2.2, 17)

leftWingCar = new Car offset along ego.orientation by -3.5 @ -10,
