...
parkedCar.behavior = DelayedLaunch(1.0, 18)

leadCar = new Car offset along ego.orientation by 0 @ 22,
    with behavior SuddenBrake(2.0, 16)

rearCar = new Car offset along ego.orientation by 0 @ -26,
    with behavior Cruise(30)

leftWingCar = new Car offset along ego.orientation by -3.5 @ -8,
    with behavior Cruise(22)
