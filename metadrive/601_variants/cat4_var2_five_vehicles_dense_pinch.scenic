...
parkedCar.behavior = DelayedLaunch(0.8, 20)

leadCar = new Car offset along ego.orientation by 0 @ 18,
    with behavior RollingBlock(2)

rearCar = new Car offset along ego.orientation by 0 @ -24,
    with behavior Cruise(28)

leftWingCar = new Car offset along ego.orientation by -3.5 @ -5,
    with behavior Cruise(24)

rightWingCar = new Car offset along ego.orientation by 3.5 @ -5,
    with behavior Cruise(24)
