...
parkedCar.behavior = DelayedLaunch(0.7, 21)

leadCar = new Car offset along ego.orientation by 0 @ 17,
    with behavior SuddenBrake(1.5, 14)

rearCar = new Car offset along ego.orientation by 0 @ -22,
    with behavior Cruise(30)

leftWingCar = new Car offset along ego.orientation by -3.5 @ -4,
    with behavior Cruise(24)

rightWingCar = new Car offset along ego.orientation by 3.5 @ -4,
    with behavior Cruise(24)

farLeadCar = new Car offset along ego.orientation by 0 @ 30,
    with behavior RollingBlock(3)
