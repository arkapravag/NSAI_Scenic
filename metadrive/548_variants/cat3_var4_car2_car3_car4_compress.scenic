...
# Three modified vehicles: compression wave ahead of ego.
...
car3 = new Car at -191.35 @ -428.69, with behavior AggressiveLaunch()
car4 = new Car at -185.67 @ -431.40, with behavior LateSwerveLeft()
