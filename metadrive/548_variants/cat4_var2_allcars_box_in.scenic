...
# Five modified vehicles: box-in pattern around traffic flow.
ego = new Car at -262.11 @ -425.37, with behavior EgoBehavior(),
    with sensors {
        "front_rgb": RGBSensor(offset=(0.3, 0, 1.7), width=1280, height=720)
    }
car2 = new Car at -197.14 @ -428.11, with behavior RollingBlock()
car3 = new Car at -191.35 @ -428.69, with behavior LateSwerveRight()
car4 = new Car at -185.67 @ -431.40, with behavior HesitateThenAccelerate()
car5 = new Car at -195.21 @ -432.27, with behavior CreepAndDriftLeft()
car6 = new Car at -204.83 @ -431.29, with behavior BrakeThenCutLeft()
