...
# Three modified vehicles: launch, swerve, and panic brake.
...
car4 = new Car at -185.67 @ -431.40, with behavior DefaultOther()
car5 = new Car at -195.21 @ -432.27, with behavior PanicBrake()
