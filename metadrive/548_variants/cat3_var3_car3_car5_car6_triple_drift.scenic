...
behavior CreepAndDriftRight():
    ...
    interrupt when 8 * STEPS_PER_SEC < simulation().currentTime and simulation().currentTime < 12 * STEPS_PER_SEC:
        take SetSteerAction(0.35)
# Three modified vehicles: two drifts with one surge.
...
car3 = new Car at -191.35 @ -428.69, with behavior CreepAndDriftLeft()
car4 = new Car at -185.67 @ -431.40, with behavior DefaultOther()
car5 = new Car at -195.21 @ -432.27, with behavior CreepAndDriftRight()
